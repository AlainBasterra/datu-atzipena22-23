...
public class MainController {
	...
	public @ResponseBody StringBuffer getOpariGuztiak() {
		StringBuffer emaitza = new StringBuffer();
		umeaRepository.findAll().forEach((umea) ->{
	...
	// @GetMapping(path = "/opariKantitatea")
	// public @ResponseBody String getOpariKantitatea() {
	// 	// This returns a JSON or XML with the users
	// 	long emaitza = 0;
	// 	umeaRepository.findAll().forEach((umea) ->{
	// 		umea.getOpariak().forEach((opari) -> {
	...
	// 		});;
	// 	});
	// 	String s=Long.toString(emaitza);
	// 	return s;
	// }   
}